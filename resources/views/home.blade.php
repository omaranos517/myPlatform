...
<head>
    ...
    <title>الأزهري - المنصة التعليمية الأولى</title>
    @vite([
    ...
    <meta name="description" content="انضم إلى الأزهري، أكبر منصة تعليمية متكاملة في مصر للمرحلتين الإعدادية والثانوية. دروس مباشرة، تسجيلات، واختبارات تفاعلية مع أفضل المدرسين.">
    <meta name="keywords" content="الأزهري, منصة تعليمية, دروس أونلاين, المرحلة الإعدادية, المرحلة الثانوية, تعليم مصر, دروس خصوصية, مدرسين متخصصين">
    <meta name="author" content="Al-Azhari Team">
    <meta property="og:title" content="الأزهري - المنصة التعليمية الأولى">
    <meta property="og:description" content="انضم إلى الأزهري، أكبر منصة تعليمية متكاملة في مصر للمرحلتين الإعدادية والثانوية. دروس مباشرة، تسجيلات، واختبارات تفاعلية مع أفضل المدرسين.">
    ...
    <section class="hero" id="hero">
        <div class="hero-content" id="hero-content">
            @auth
                ...
                <p class="animate__animated animate__fadeInUp">سعداء بانضمامك إلى عائلة الأزهري للمرحلتين الإعدادية والثانوية.<br>أكبر منصة تعليمية متكاملة</p>
            ...
            @endauth
            @guest
                <h1 class="animate__animated animate__fadeInDown">أهلاً بك في عائلة الأزهري</h1>
                ...
                <div class="hero-buttons animate__animated animate__fadeInUp">
                    ...
                    <a href="#features" class="hero-btn secondary">
                        <i class="fas fa-info-circle"></i> لماذا نختار الأزهري؟
                    </a>
                </div>
            @endguest
        </div>
